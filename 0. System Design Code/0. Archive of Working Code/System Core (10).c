//this code uses intrrupts to echo characters...
//this is as lucky I can get to day
//lets see if I can do this with a software buffer now.
...
////setup interrupts
	...
	// fprintf(GSM,"\r\nRunning...\r\n");
	fputs("this is somethig",PC);

////Program Loop
while (TRUE){
	//fputs("this is a test of interrupt uart",PC);
	while (!got_char_flag);
	//blinkA1(1);
	c = received_char;
	got_char_flag = 0;
